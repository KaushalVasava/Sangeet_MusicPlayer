...
public class FavoriteFragmentDirections {
  ...
  @NonNull
  public static ActionFavoriteFragmentToPlayerFragment actionFavoriteFragmentToPlayerFragment(
      int position, int songId, int playlistPos) {
    return new ActionFavoriteFragmentToPlayerFragment(position, songId, playlistPos);
  }

  public static class ActionFavoriteFragmentToPlayerFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionFavoriteFragmentToPlayerFragment(int position, int songId, int playlistPos) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavoriteFragmentToPlayerFragment setPosition(int position) {
      this.arguments.put("position", position);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavoriteFragmentToPlayerFragment setSongId(int songId) {
      this.arguments.put("songId", songId);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavoriteFragmentToPlayerFragment setPlaylistPos(int playlistPos) {
      this.arguments.put("playlistPos", playlistPos);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_favoriteFragment_to_playerFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionFavoriteFragmentToPlayerFragment that = (ActionFavoriteFragmentToPlayerFragment) object;
    ...
    public String toString() {
      return "ActionFavoriteFragmentToPlayerFragment(actionId=" + getActionId() + "){"
