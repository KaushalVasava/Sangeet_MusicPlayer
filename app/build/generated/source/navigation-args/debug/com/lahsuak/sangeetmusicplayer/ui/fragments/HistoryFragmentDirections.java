...
public class HistoryFragmentDirections {
  ...
  @NonNull
  public static ActionHistoryFragmentToPlayerFragment actionHistoryFragmentToPlayerFragment(
      int position, int songId, int playlistPos) {
    return new ActionHistoryFragmentToPlayerFragment(position, songId, playlistPos);
  }

  public static class ActionHistoryFragmentToPlayerFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionHistoryFragmentToPlayerFragment(int position, int songId, int playlistPos) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionHistoryFragmentToPlayerFragment setPosition(int position) {
      this.arguments.put("position", position);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionHistoryFragmentToPlayerFragment setSongId(int songId) {
      this.arguments.put("songId", songId);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionHistoryFragmentToPlayerFragment setPlaylistPos(int playlistPos) {
      this.arguments.put("playlistPos", playlistPos);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_historyFragment_to_playerFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionHistoryFragmentToPlayerFragment that = (ActionHistoryFragmentToPlayerFragment) object;
    ...
    public String toString() {
      return "ActionHistoryFragmentToPlayerFragment(actionId=" + getActionId() + "){"
