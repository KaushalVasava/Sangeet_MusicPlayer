...
import com.lahsuak.sangeetmusicplayer.util.service.MusicService.Companion.playlistPosition
...
//        }
    ...
    override fun onItemClicked(position: Int, id: Int) {
        val editor: SharedPreferences.Editor =
            requireActivity().getSharedPreferences(AppConstants.MUSIC_LAST_PLAYED, MODE_PRIVATE).edit()
