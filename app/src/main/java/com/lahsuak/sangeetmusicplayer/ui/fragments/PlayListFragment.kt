...
import com.lahsuak.sangeetmusicplayer.ui.adapters.PlaylistAdapter
import com.lahsuak.sangeetmusicplayer.ui.adapters.PlaylistListener
...
class PlayListFragment : Fragment(R.layout.fragment_playlist) , PlaylistListener {
    ...
    override fun onCreateView(
        ...
        playlistAdapter =
            PlaylistAdapter(musicPlaylist.ref!!, this@PlayListFragment)
        ...
        if(result){
            val editor1: SharedPreferences.Editor =
                requireActivity().getSharedPreferences(PLAYLIST, Context.MODE_PRIVATE)
                    .edit()
            editor1.putInt(AppConstants.PLAYLIST_LAST_PLAYED, tempPos)
            editor1.apply()
        }
